 ...
 *  version GST3.0.4
 *  Last Updated:  anjali.garg01, June 08 2021
 **/
'use strict';
var fs = require('fs');
...
exports.formDataFormat = function(req, callback)
{
  ...
  if (form == "GSTR1" || form == 'GSTR1A')
  {
    if (isNaN(gt))
    {
      ...
      formDataFormat = "{ " + '"gstin":"' + gstin + '",' + '"fp":"' + fp + '",' + '"version":"' + version + '",' + '"hash":"' + hash + '",' + '"b2b" :[' + " " + "]" + ',' + '"b2ba" :[' + "" + "]" + ',' + '"b2cl":[' + "" + "]" + ',' + '"b2cla":[' + "" + "] " + ',' + '"b2cs":[' + " " + "]" + ',' + '"b2csa":[' + " " + "]" + ',' + '"nil":{"inv":[' + "" + "]}" + ',' + '"exp":[' + " " + "] " + ',' + '"expa":[' + " " + "]  " + ',' + '"hsnSac":[' + " " + "]  " + ',' + '"cdnra":[' + " " + "]  " + ',' + '"at":[' + " " + "]  " + ',' + '"ata":[' + " " + "]  " + ',' + '"cdnr":[' + " " + "] " + ',' + '"cdnur":[' + " " + "] " + ',' + '"cdnura":[' + " " + "] " + ',' + '"atadj":[' + " " + "]  " + ',' + '"atadja":[' + " " + "]  " + ',' + '"doc_issue":{"doc_det":[' + " " + "]}" + ',' + '"hsn":{"data":[' + " " + "]}   }"
    }
    else
    {
      logger.log("info", " creating formDataFormat of form :: %s ", form);
      formDataFormat = "{ " + '"gstin":"' + gstin + '",' + '"fp":"' + fp + '",' + '"gt":' + gt + ',' + '"cur_gt":' + cur_gt + ',' + '"version":"' + version + '",' + '"hash":"' + hash + '",' + '"b2b" :[' + " " + "]" + ',' + '"b2ba" :[' + "" + "]" + ',' + '"b2cl":[' + "" + "]" + ',' + '"b2cla":[' + "" + "] " + ',' + '"b2cs":[' + " " + "]" + ',' + '"b2csa":[' + " " + "]" + ',' + '"nil":{"inv":[' + "" + "]}" + ',' + '"exp":[' + " " + "] " + ',' + '"expa":[' + " " + "]  " + ',' + '"hsnSac":[' + " " + "]  " + ',' + '"cdnra":[' + " " + "]  " + ',' + '"at":[' + " " + "]  " + ',' + '"ata":[' + " " + "]  " + ',' + '"cdnr":[' + " " + "] " + ',' + '"cdnur":[' + " " + "] " + ',' + '"cdnura":[' + " " + "] " + ',' + '"atadj":[' + " " + "]  " + ',' + '"atadja":[' + " " + "]  " + ',' + '"doc_issue":{"doc_det":[' + " " + "]}" + ',' + '"hsn":{"data":[' + " " + "]}   }"
    }
