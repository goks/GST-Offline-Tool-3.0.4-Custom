            ...
            case 'hsn':
                ...
                if (!isCurrentPeriodBeforeAATOCheck(newHSNStartDateConstant, thisShareData.monthSelected.value)) {
                    ...
                    isPttnMthced = (
                        ...
                        validatePattern(iInv['Rate'], isRateReqd, /^(0|0.1|0.25|1|1.5|3|5|7.5|12|18|28)$/) && //RateValidationInReturn
...
var preparePayloadFromExcel = function (oData, getInvFn, getItmFn, excelRefKey, newFormateKey, iSecID, iForm, iMonthsList, iYearsList, iSpLs, supplier_gstin, isSEZ, uploadImport) {
    ...
    angular.forEachCustom(iData, function (inv, i) {
        ...
        if (isValidExcelData && isValidExcelDates && isValidExcelFields && isValidExcelActions && isValidExcelErrorActions && isValidShipDate) {
        ...
        } else if (curInum && isValidExcelData && isValidExcelFields && isValidExcelActions && isValidExcelErrorActions && isValidShipDate) {
